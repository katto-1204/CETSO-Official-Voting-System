  ...
  return (
    <footer
      ...
      style={{
        ...
        background: 'linear-gradient(to bottom, rgba(13,8,0,0.95), #050300)',
      }}
    >
      {/* Decorative Grid */}
      <div
      ...
      <div className="mx-auto max-w-7xl relative">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
          ...
          <div className="md:col-span-5 space-y-8">
            <div className="flex items-center gap-4">
              <div
                className="grid h-12 w-12 place-items-center rounded-[18px] font-black text-white text-xl"
                style={{
              ...
              <div>
                <div className="text-2xl font-black uppercase tracking-widest text-white italic" style={{ fontFamily: 'var(--font-h1)', lineHeight: 0.9 }}>
                  CETSO<br /><span className="text-[11px] not-italic tracking-[0.4em] text-[var(--cetso-orange)] opacity-80">Official Portal</span>
                </div>
              </div>
            </div>
            
            <p className="text-sm font-medium leading-relaxed max-w-sm text-white/40 italic">
            ...
            <div className="flex items-center gap-4">
              {[MessageCircle, Share2, Globe].map((Icon, i) => (
                <button
                  key={i}
                  className="grid h-10 w-10 place-items-center rounded-xl bg-white/5 border border-white/5 text-white/40 hover:text-[var(--cetso-orange)] hover:border-[var(--cetso-orange)]/30 hover:bg-[var(--cetso-orange)]/5 transition-all"
                >
          ...
          <div className="md:col-span-3 space-y-6">
            <div className="flex items-center gap-2">
              ...
              <div className="text-[10px] font-black uppercase tracking-[0.2em] text-white/40">Navigation</div>
            </div>
            <ul className="space-y-4">
              {[
                ...
                <li key={link.label}>
                  <Link
                    to={link.to}
                    className="group flex items-center gap-3 text-sm font-bold text-white/60 hover:text-white transition-colors"
                  >
          ...
          <div className="md:col-span-4 space-y-6">
            <div className="flex items-center gap-2">
              ...
              <div className="text-[10px] font-black uppercase tracking-[0.2em] text-white/40">System Security</div>
            </div>
            ...
            >
              ...
              <Cpu className="absolute -right-4 -bottom-4 h-24 w-24 text-white/[0.02] rotate-12 group-hover:rotate-0 transition-transform duration-1000" />
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-[9px] font-black px-2 py-0.5 rounded bg-white/5 text-white/30 uppercase">Secure</div>
              </div>

              <div className="space-y-2">
                <div className="flex justify-between text-[11px] font-medium">
                  <span className="text-white/40 italic">Integrity:</span>
                  <span className="text-white/80">SHA-256 Verified</span>
                </div>
                <div className="flex justify-between text-[11px] font-medium">
                  <span className="text-white/40 italic">Uptime:</span>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-8">
          ...
          <div className="text-[10px] font-black uppercase tracking-[0.25em] text-white/20 text-center italic">
